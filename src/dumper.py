...
class Dumper:
    def __init__(self, ipc_client: GreengrassCoreIPCClientV2, thing_name: str, shadow_name: str, rawdata_topic: str, write_rule: str, save_directory: str):
    ...
    def _on_rawdata_stream_event(self, event: SubscriptionResponseMessage):
        try:
    ...
    def subscribe_rawdata_topic(self):
        self.ipc_client.subscribe_to_topic(
